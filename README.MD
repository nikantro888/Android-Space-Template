...
1. Clone a target empty repository such as https://github.com/SpaceBank/Android-Space-Core-Presentation

2. Download template zip file and paste all files inside cloned repository except README.MD 
